...
public class Decide {
    ...
    public static void main(String[] args) {
        // Set up test variables and create Decide object which will results in a positive outcome

        // decidePositive will return "YES" on stdout since the PUV is all set to false, so no matter
        // what values the LIC's sets the CMV vector to, or what the PUM is calculated to, the FUV will
        // all be true as the PUV is all false.
        Decide decidePositive = new Decide(5,
                new Coordinate[]{new Coordinate(0, 2), new Coordinate(0, 3), new Coordinate(10, 25), new Coordinate(20, 35), new Coordinate(30, 50)},
                new Parameters(
                        1,
                        1,
                        1,
        ...
        // With these parameters only row 3 in the PUM will be looked at. On row 3 only the 4 first columns will be looked at
        // as per the LCM.
        // LIC0 will be true
        // LIC1 will be true
        // LIC2 will be false
        // LIC3 will be true
        // PUM[3][0] is OOR, so true
        // PUM[3][1] is OOR, so true
        // PUM[3][2] is AAND, so FALSE
        // PUM[3][3] is AAND, so true
        // Therefore the FUV will not all be true, and the launch will not be executed
        Decide decideNegative = new Decide(5,
                new Coordinate[]{new Coordinate(0, 2), new Coordinate(0, 3), new Coordinate(10, 25), new Coordinate(20, 35), new Coordinate(30, 50)},
                new Parameters(
                        1,
                        1,
                ...
                new Decide.CONNECTORS[][] {
                        ...
                        {CONNECTORS.ORR, CONNECTORS.ORR, CONNECTORS.ORR, CONNECTORS.ORR, CONNECTORS.NOTUSED, CONNECTORS.NOTUSED, CONNECTORS.NOTUSED, CONNECTORS.NOTUSED, CONNECTORS.NOTUSED, CONNECTORS.NOTUSED, CONNECTORS.NOTUSED, CONNECTORS.NOTUSED, CONNECTORS.NOTUSED, CONNECTORS.NOTUSED, CONNECTORS.NOTUSED},
                        {CONNECTORS.NOTUSED, CONNECTORS.NOTUSED, CONNECTORS.NOTUSED, CONNECTORS.NOTUSED, CONNECTORS.NOTUSED, CONNECTORS.NOTUSED, CONNECTORS.NOTUSED, CONNECTORS.NOTUSED, CONNECTORS.NOTUSED, CONNECTORS.NOTUSED, CONNECTORS.NOTUSED, CONNECTORS.NOTUSED, CONNECTORS.NOTUSED, CONNECTORS.NOTUSED, CONNECTORS.NOTUSED, CONNECTORS.NOTUSED,},
                        {CONNECTORS.NOTUSED, CONNECTORS.NOTUSED, CONNECTORS.NOTUSED, CONNECTORS.NOTUSED, CONNECTORS.NOTUSED, CONNECTORS.NOTUSED, CONNECTORS.NOTUSED, CONNECTORS.NOTUSED, CONNECTORS.NOTUSED, CONNECTORS.NOTUSED, CONNECTORS.NOTUSED, CONNECTORS.NOTUSED, CONNECTORS.NOTUSED, CONNECTORS.NOTUSED, CONNECTORS.NOTUSED, CONNECTORS.NOTUSED,},
                        {CONNECTORS.NOTUSED, CONNECTORS.NOTUSED, CONNECTORS.NOTUSED, CONNECTORS.NOTUSED, CONNECTORS.NOTUSED, CONNECTORS.NOTUSED, CONNECTORS.NOTUSED, CONNECTORS.NOTUSED, CONNECTORS.NOTUSED, CONNECTORS.NOTUSED, CONNECTORS.NOTUSED, CONNECTORS.NOTUSED, CONNECTORS.NOTUSED, CONNECTORS.NOTUSED, CONNECTORS.NOTUSED, CONNECTORS.NOTUSED,},
                        {CONNECTORS.NOTUSED, CONNECTORS.NOTUSED, CONNECTORS.NOTUSED, CONNECTORS.NOTUSED, CONNECTORS.NOTUSED, CONNECTORS.NOTUSED, CONNECTORS.NOTUSED, CONNECTORS.NOTUSED, CONNECTORS.NOTUSED, CONNECTORS.NOTUSED, CONNECTORS.NOTUSED, CONNECTORS.NOTUSED, CONNECTORS.NOTUSED, CONNECTORS.NOTUSED, CONNECTORS.NOTUSED, CONNECTORS.NOTUSED,},
                ...
                new boolean[]{false, false, true, false, false, false, false, false, false, false, false, false, false, false, false});

        Decide decideInvalid = new Decide(1,
                new Coordinate[]{new Coordinate(0, 2)},
                new Parameters(
                        1,
                        1,
                        1,
        ...
        boolean launch = decidePositive.decide();
        System.out.print("Launch based on decidePositive? ");
        if (launch) {
        ...
        launch = decideNegative.decide();
        System.out.print("Launch based on decideNegative? ");
        if (launch) {
            System.out.println("YES");
        } else {
            System.out.println("NO");
        ...
        launch = decideInvalid.decide();
        System.out.print("Launch based on decideInvalid? ");
        if (launch) {
            System.out.println("YES");
        } else {
            System.out.println("NO");
